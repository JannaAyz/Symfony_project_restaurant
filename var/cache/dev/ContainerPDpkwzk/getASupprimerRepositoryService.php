 ...
 */
class getASupprimerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ASupprimerRepository' shared autowired service.
     *
     * @return \App\Repository\ASupprimerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ASupprimerRepository.php';

        return $container->privates['App\\Repository\\ASupprimerRepository'] = new \App\Repository\ASupprimerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
