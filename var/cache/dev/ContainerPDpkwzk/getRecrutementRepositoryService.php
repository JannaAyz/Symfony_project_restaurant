 ...
 */
class getRecrutementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RecrutementRepository' shared autowired service.
     *
     * @return \App\Repository\RecrutementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RecrutementRepository.php';

        return $container->privates['App\\Repository\\RecrutementRepository'] = new \App\Repository\RecrutementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
